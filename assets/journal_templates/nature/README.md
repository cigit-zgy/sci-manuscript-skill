# Springer Nature journal template resource

- Template name: `sn-jnl`
- Template type: official Springer Nature journal article template; not a
  universal Nature Portfolio journal class
- Publisher source: https://www.springernature.com/gp/authors/campaigns/latex-author-support
- Package source: https://cms-resources.apps.public.k8s.springernature.io/springer-cms/rest/v1/content/18782940/data/v12
