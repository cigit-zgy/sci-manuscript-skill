...
% Safe defaults also protect projects initialized before the breakable style.
\providecommand{\RevisionAddedText}[1]{{\color{RevisionAddedColor}#1}}
\providecommand{\RevisionDeletedText}[1]{{\color{RevisionDeletedColor}#1}}
\providecommand{\RevisionSelfText}[1]{{\color{RevisionSelfColor}#1}}
