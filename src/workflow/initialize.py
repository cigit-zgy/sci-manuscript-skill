"""Project initialization and safe infrastructure migration."""
...
from ..latex.numbering import round_directory_name
...
from ..resources import read_resource_text, resource
from ..results import Artifact, InitializationResult, UpgradeResult
...
from .revision import init_response, parse_reviews
from .rollback import reindex_execute, reindex_plan
